...
class AugmentedEvent {
  ...
  update(e) {
    ...
    const docEl = document.documentElement;
    if (_globalVars.default.enableScrollInfo && (mainType === 'scroll' || mainType === 'touchmove')) {
    ...
    if (_globalVars.default.enableResizeInfo && mainType === 'resize') {
      this.resize.width = window.innerWidth || docEl.clientWidth;
      this.resize.height = window.innerHeight || docEl.clientHeight;
    }
    if (_globalVars.default.enableTouchInfo && e.touches && (mainType === 'touchstart' || mainType === 'touchmove' || mainType === 'touchend')) {
      let pos;
      let absX;
      let absY;
...
var _default = exports.default = AugmentedEvent;
