                ...
                <div className="!ml-72 flex-1 !px-10 !py-2">
                    ...
                    <div className="flex justify-between items-center !mb-8">
                        ...
                        <div className="flex items-center !space-x-2">
                            ...
                            <div className="relative bg-neutral-800 rounded-lg !px-2 !py-2">
                                <Bell size={20} className="text-neutral-400 hover:text-white cursor-pointer" />
                                {notifications > 0 && (
                                    <span className="absolute z-10 -top-1 -right-1 bg-red-500 text-white text-[0.7rem] w-3.5 h-3.5 flex items-center justify-center rounded-full">
                                        {notifications}
                                    </span>
                                )}
                            </div>
                                    ...
                                    <tbody>
                                        {dashboardData.recentOrders.map((order) => (
                                            <tr key={order.id} className="border-b border-neutral-800/50 text-sm">
                                                ...
                                                <td className="!py-3">
                                                    <span className={`!px-2 !py-1 rounded-full text-xs ${order.status === 'Delivered' ? 'bg-green-500/10 text-green-500' :
