                    ...
                    <div className="flex justify-between items-center !mb-8">
                        ...
                        <div className="flex items-center !space-x-2">
                            <button
                                ...
                                className="bg-white text-sm text-black !px-4 !py-2 flex items-center rounded-lg cursor-pointer gap-2"
                            >
                                Add Product
                                <Plus size={18} />
                            </button>
                            <Link to="/" className="text-sm rounded-lg  bg-neutral-800 border border-neutral-800 text-neutral-400 hover:text-white !px-2 !py-2 flex items-center cursor-pointer gap-2">
                                <Home size={18} />
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row justify-between gap-4 !mb-6">
                        <div className="relative flex-1">
                            <input
                                ...
                                className="w-full bg-neutral-800 border border-neutral-700 rounded-md !py-2 !pl-10 !pr-4 focus:outline-none focus:border-neutral-500"
                                value={searchTerm}
