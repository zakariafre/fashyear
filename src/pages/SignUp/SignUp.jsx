...
const SignUp = () => {
    ...
    return (
        <div className="w-screen h-screen grid grid-cols-1 md:grid-cols-[45%_55%] bg-[#121212] text-white">
            {/* Left Section - Image */}
            <div className="hidden md:block h-full w-full relative overflow-hidden">
                {/* Back to home button */}
                <div className="absolute top-6 right-6 z-20">
                    <Link to="/" className="flex items-center gap-2 bg-neutral-800/40 backdrop-blur-xs !py-2 !px-4 border border-neutral-400 transition-colors">
                    ...
                    <form onSubmit={handleSubmit} className="w-full flex flex-col gap-8">
                        ...
                        <div className="flex items-start gap-2">
                            ...
                            <label htmlFor="terms" className="text-xs text-neutral-400">
                                I agree to the <span className="text-neutral-200 underline cursor-pointer">Terms of Service</span> and <span className="text-neutral-200 underline cursor-pointer">Privacy Policy</span>
                            </label>
                        </div>
                        ...
                        {/* Login Link */}
                        <div className='flex flex-row gap-2 text-sm font-light justify-center'>
                            <p className='text-neutral-400'>Already have an account?</p>
                            <Link to="/login" className="text-neutral-200 underline underline-offset-2 hover:text-neutral-200">
                                Log In
                            </Link>
                        </div>
                    </form>
