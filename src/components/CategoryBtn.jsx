...
const CategoryBtn = ({ text, isActive, onClick }) => {
    return (
        <button
            id='customSpan2'
            onClick={onClick}
            className={` cursor-pointer transition-all duration-500 ease-in-out inline-flex items-center span gap-5 border font-medium rounded-[30rem] text-[1.5rem] leading-[2rem]
