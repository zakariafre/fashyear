...
const Search = ({ isSearchOpen, setIsSearchOpen, products }) => {
    ...
    return (
        <>
            ...
            {isSearchOpen && (
                <div
                    className="fixed inset-0 bg-black/90 backdrop-blur-md z-50 transition-opacity duration-400 overflow-hidden"
            ...
            <div
                ...
                className={`fixed top-5 w-[80%] left-1/2 transform -translate-x-1/2 rounded-[2rem] bg-[#303030]/90 z-60 flex flex-col justify-start items-center gap-7 !pt-25 !pb-6 duration-300 overflow-hidden
